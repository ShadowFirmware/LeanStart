          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium" style={{ color: "#F2F0F7" }}>{h.titulo}</p>
                <p className="text-xs mt-0.5 leading-relaxed line-clamp-1" style={{ color: "#7E7C86" }}>{h.descripcion}</p>
              ...
              <button
                onClick={() => {
                  eliminarHipotesis(empresaId, h.id);
                ...
                render={({ field }: { field: ControllerRenderProps<FormValues, "descripcion"> }) => (
                  <FormItem className="gap-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs" style={{ color: (field.value?.length ?? 0) < 20 ? "#4A4850" : "#7E7C86" }}>{field.value?.length ?? 0} / mín. 20</span>
                    </div>
                    <FormControl>
                      <Textarea className="min-h-20 resize-none text-sm focus-visible:ring-0" style={{ backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#F2F0F7" }} {...field} />
                    </FormControl>
                    <FormMessage className="text-xs" />
                  </FormItem>
                )}
          ...
          <>
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <h1 className="text-xl font-bold" style={{ color: "#F2F0F7" }}>{empresa.nombre}</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: "#C4C2CC" }}>{empresa.descripcion}</p>
              </div>
              <div>
                <p className="text-xs font-medium uppercase tracking-wider mb-2" style={{ color: "#4A4850" }}>Mercado objetivo</p>
                <p className="text-sm leading-relaxed" style={{ color: "#C4C2CC" }}>{empresa.mercadoObjetivo}</p>
              </div>
            </div>
